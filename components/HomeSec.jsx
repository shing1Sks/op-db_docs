  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-[60px] w-full dark:bg-grid-white/[0.2] bg-grid-black/[0.2] pt-8 pb-20">
        <p className="text-center text-xl sm:text-3xl text-black font-bold dark:text-white my-2 sm:my-4">
          Introducing op-db:
        </p>
        <TypewriterEffectSmooth words={words} />
        <p className="w-[80%] text-gray-800 text-sm sm:text-xl dark:text-gray-200">
        ...
        <p className="w-[90%] pt-2 text-gray-800 text-sm sm:text-xl dark:text-gray-200">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-evenly text-left py-4 border-t-2 border-t-black my-1 border-b-2 border-b-black dark:border-t-white dark:border-b-white">
        <div className="text-xl sm:text-4xl text-gray-800 font-bold dark:text-white">
          Get Started - !{" "}
        </div>
      ...
      <div className="flex flex-row text-left border-t-2 border-b-2 my-2 border-gray-200 dark:bg-slate-700">
        <div className="w-[60%] px-4 py-2">
          ...
          <ol className="text-gray-800 text-sm sm:text-xl dark:text-gray-50">
            <li>
      ...
      <div className="mt-[60px] w-full dark:bg-grid-white/[0.2] bg-grid-black/[0.2] py-3 mb-4 border-b-2 border-gray-300 border-t-2">
        <p className="text-xl sm:text-3xl text-center text-gray-700 dark:text-white font-bold">
          How iT works ? -- Overveiw !
        </p>
        <p className="text-gray-600 dark:text-gray-200 text-sm sm:text-lg text-justify px-4">
