...
function UpdtEm() {
  const statement =
    "Simply send new email and enjoy !";
  const req = [
    "{",
    '  "email": "hc.gmail123.co.in",',
    "}",
  ];
  const res = [
    "{",
    ...
    '            "email": "hc.gmail123.co.in",',
    '            "score": 0,',
    '            "avatar": "http://res.cloudinary.com/----/image/upload/-----/--NEW--jpg",',
    '            "likes": [],',
    '            "comments": [],',
    '            "posts": [],',
    '            "followers": [],',
  ...
  const endpoint = "http://localhost:8000/api/user/update-email";
  return (
    <Req_Res
      statement={statement}
      type={type}
